...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse">
            <a class="navbar-brand" href="#">turnie.re</a>
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Features <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Turnier erstellen</a>
                </li>
                <li class="nav-item">
...
<main role="main">
    ...
    <div class="big-image">
        <h1>Einfach Turniere organisieren</h1>
    </div>
    ...
    <footer class="footer mt-5 bg-dark text-light">
        <div class="container py-3">
            <div class="row">
                <div class="col-md-6 text-center">&copy; 2018 Team REST &middot; <a class="text-white" href="#">DSGVO-Kram</a> &middot; <a
                        class="text-white" href="#">Impressum</a></div>
